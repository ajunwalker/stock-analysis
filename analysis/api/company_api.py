...
class CompanyAPI(BaseAPI):
	...
	async def get_daily_shares(symbol: str) -> pd.DataFrame:
		url = f"/v4/historical/shares_float"
	...
	@staticmethod
	async def get_balance_sheet_statements(symbol: str, period: str="quarter") -> pd.DataFrame:
	...
	@staticmethod
	async def get_income_statements(symbol: str, period: str="quarter") -> pd.DataFrame:
	...
	@staticmethod
	async def get_cash_flow_statements(symbol: str, period: str="quarter") -> pd.DataFrame:
